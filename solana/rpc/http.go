...
func (client *ThinClient) GetFeeForMessage(ctx context.Context, query GetFeeForMessageQuery) (model.RawResult, error) {
	return client.rawMethod(ctx, RPCMethodGetFeeForMessage, rawCallParams(query.Id, optionalParams([]any{query.Message}, optionalCommitment(query.Commitment))...))
}

func (client *ThinClient) GetEpochInfo(ctx context.Context, query GetEpochInfoQuery) (model.RawResult, error) {
	return client.rawMethod(ctx, RPCMethodGetEpochInfo, rawCallParams(query.Id, optionalParams(nil, optionalCommitment(query.Commitment))...))
}

func (client *ThinClient) GetLatestBlockhash(ctx context.Context, query GetLatestBlockhashQuery) (model.RawResult, error) {
	return client.rawMethod(ctx, RPCMethodGetLatestBlockhash, rawCallParams(query.Id, optionalParams(nil, optionalCommitment(query.Commitment))...))
}
...
func (client *ThinClient) GetTransactionCount(ctx context.Context, query GetTransactionCountQuery) (model.RawResult, error) {
	return client.rawMethod(ctx, RPCMethodGetTransactionCount, rawCallParams(query.Id, optionalParams(nil, optionalCommitment(query.Commitment))...))
}

func (client *ThinClient) IsBlockhashValid(ctx context.Context, query IsBlockhashValidQuery) (model.RawResult, error) {
	return client.rawMethod(ctx, RPCMethodIsBlockhashValid, rawCallParams(query.Id, optionalParams([]any{query.Blockhash}, optionalCommitment(query.Commitment))...))
}
...
func (client *ThinClient) GetBlock(ctx context.Context, query GetBlockQuery) (model.RawResult, error) {
	return client.rawMethod(ctx, RPCMethodGetBlock, rawCallParams(query.Id, optionalParams([]any{query.Slot}, optionalCommitment(query.Commitment))...))
}
...
func (client *ThinClient) GetBlockHeight(ctx context.Context, query GetBlockHeightQuery) (model.RawResult, error) {
	return client.rawMethod(ctx, RPCMethodGetBlockHeight, rawCallParams(query.Id, optionalParams(nil, optionalCommitment(query.Commitment))...))
}

func (client *ThinClient) GetBlockProduction(ctx context.Context, query GetBlockProductionQuery) (model.RawResult, error) {
	return client.rawMethod(ctx, RPCMethodGetBlockProduction, rawCallParams(query.Id, optionalParams(nil, optionalQueryConfig(query))...))
}
...
func (client *ThinClient) GetConfirmedSlots(ctx context.Context, query GetConfirmedSlotsQuery) (model.ConfirmedSlots, error) {
	response, err := client.rawMethod(ctx, RPCMethodGetBlocks, rawCallParams(query.Id, query.From, query.To, map[string]string{"commitment": query.Commitment}))
	if err != nil {
		return nil, err
	}
...
func (client *ThinClient) GetSlot(ctx context.Context, query GetSlotQuery) (model.Slot, error) {
	response, err := client.rawMethod(ctx, RPCMethodGetSlot, rawCallParams(query.Id, optionalParams(nil, optionalCommitment(query.Commitment))...))
	if err != nil {
		return 0, err
	}
...
func (client *ThinClient) GetSlotLeader(ctx context.Context, query GetSlotLeaderQuery) (model.RawResult, error) {
	return client.rawMethod(ctx, RPCMethodGetSlotLeader, rawCallParams(query.Id, optionalParams(nil, optionalCommitment(query.Commitment))...))
}
